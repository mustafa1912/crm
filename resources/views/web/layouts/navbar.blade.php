        ...
        <div class="topbar">
            ...
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-lg btn-dropdown ml-1">
            ...
            <div class="dropdown">
                <!--begin::Toggle-->
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg ml-1 pulse pulse-primary">
                        <span class="svg-icon svg-icon-xl svg-icon-primary">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <form>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                <!--begin::Scroll-->
                                <div class="scroll pr-7 ml-n7" data-scroll="true" data-height="300" data-mobile-height="200">
                                    <!--begin::Item-->
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-dropdown btn-lg ml-1" id="kt_quick_cart_toggle">
                    <span class="svg-icon svg-icon-xl svg-icon-primary">
            ...
            <!--begin::Quick panel-->
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-lg ml-1" id="kt_quick_panel_toggle">
                    <span class="svg-icon svg-icon-xl svg-icon-primary">
            ...
            <!--begin::Chat-->
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-lg ml-1" data-toggle="modal" data-target="#kt_chat_modal">
                    <span class="svg-icon svg-icon-xl svg-icon-primary">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg ml-1">
                        <img class="h-20px w-20px rounded-sm" src="{{ asset('public/admin/media/svg/flags/226-united-states.svg') }}" alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 ml-3">
                                    <img src="{{ asset('public/admin/media/svg/flags/226-united-states.svg') }}" alt="" />
                        ...
                        <li class="navi-item active">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 ml-3">
                                    <img src="{{ asset('public/admin/media/svg/flags/128-spain.svg') }}" alt="" />
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 ml-3">
                                    <img src="{{ asset('public/admin/media/svg/flags/162-germany.svg') }}" alt="" />
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 ml-3">
                                    <img src="{{ asset('public/admin/media/svg/flags/063-japan.svg') }}" alt="" />
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    <span class="text-muted font-weight-bold font-size-base d-none d-md-inline ml-1">Hi,</span>
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline ml-3">Sean</span>
